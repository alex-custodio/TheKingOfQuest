...
func _on_killskele_body_entered(body):
	if body.name == "Player":
		$AnimatedSprite.play("dead")
		$killskele/CollisionPolygon2Dk.queue_free()
		$dieskele/CollisionPolygon2Dd.queue_free()
		$dieskele/CollisionPolygon2Dd2.queue_free()
		speed = 0
